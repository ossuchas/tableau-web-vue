...
export default {
  ...
  data() {
    return {
      ...
      viewname: "Dashboard BL Performance LCM",
      ticket: "",
      url: "",
    };
  },
            ...
            .then((profile) => {
              ...
              axios.get("/genticket").then((response) => {
                ...
                this.url =
                  ...
                  "/" +
                  this.ticket +
                  "/t/CRM/views/ChatbotPerformanceLCM/DSBLPerformanceLCM?:refresh=true&:embed=yes&:toolbar=no&:tabs=no&p_param1=" + this.userId;
              });
            })
            .catch((err) => {
              console.error(err);
          ...
          console.log("LIFF is not logged in");
              ...
              axios.get("/genticket").then((response) => {
                ...
                this.url =
                  ...
                  "/" +
                  this.ticket +
                  "/t/CRM/views/ChatbotPerformanceLCM/DSBLPerformanceLCM?:refresh=true&:embed=yes&:toolbar=no&:tabs=no&:render=false&p_param1=" + this.userId;
              });
        }
      })
      .catch((err) => {
